                ...
                <div class="modal-content">
                    ...
                    <form id="formTambah">
                        <div class="modal-body">
                            ...
                            <textarea name="word_detail" id="word_detail" class="form-control summernote" ></textarea>
                            <script>
                             $('#word_detail').summernote({
                ...
                <div class="modal-content">
                    ...
                    <form id="formUbah">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>word</label>
                                <input type="text" class="form-control" id="word_ubah" name="word" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>speech</label>
                                <input type="text" class="form-control" id="speech_ubah" name="speech" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Level</label>
                                <input type="text" class="form-control" id="level_ubah" name="level" autocomplete="off">
                                
                            </div>

                            <div class="form-group">
                                <label>Meaning</label>
                                <input type="text" class="form-control" id="meaning_ubah" name="meaning" autocomplete="off">
                               
                            </div>
                            <div class="form-group">
                            <label>Word Detail</label>

                            <textarea name="word_detail" id="word_detail_ubah" class="form-control summernote"></textarea>
                            <script>
                             $('#word_detail_ubah').summernote({
                             placeholder: '',
                             tabsize: 2,
                             height: 100
                             });
        ...
        $(document).ready(function(){
            ...
            var table = $('#tabel-transaksi').DataTable( {
                ...
                "columnDefs": [ 
                    ...
                    { "targets": 2, "width": '250px', "className": 'center' },
                    { "targets": 3, "width": '200px', "className": 'center' },
                    { "targets": 4, "width": '200px', "className": 'center' },
                    { "targets": 5, "width": '200px', "className": 'center' },
                    { "targets": 6, "width": '200px', "className": 'center' },
            ...
            $('#btnUbah').click(function(){
                ...
                else if ($('#word_detail_ubah').val()=="" || $('#word_detail_ubah').val()==0){
                    // focus ke input meaning
            ...
            $('#tabel-transaksi tbody').on( 'click', '.btnHapus', function (){
                ...
                swal({
                    ...
                    html: true,
                    text: "Anda akan menghapus data wordlist dengan ID : "+ data[ 1 ] +"",
                    type: "warning",
